...
public class TestCodePacker
{
	...
	public TestCodePacker(String _filename)
	{
		filename = _filename;
		try
		{
			...
			else	
			{
			    ...
			    JFrame frame = new JFrame("TestCodePacker");
	...
	class ApplyHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			for(int i = 0; i < 3; i++)
			{
				...
				string_rate       /= pixel_length;
				System.out.println("The packed string rate from packStrings is " + String.format("%.4f", string_rate));
			    ...
			    System.out.println("The maximum length for a unary code is " + max_length);
			    ...
			    else
			    {
				    ...
				    string_rate     = bit_length;
				    string_rate    /= pixel_length;
				    System.out.println("The unary rate from pack function is " + String.format("%.4f", string_rate));
				    zero_ratio      = DeltaMapper.getZeroRatio(compressed_string, bit_length);
				    System.out.println("The zero ratio of the string produced by packCode is " + String.format("%.4f", zero_ratio));
			    }
