...
public class AdaptiveTester
{
	...
	public static void main(String[] args)
	{
		if (args.length != 1)
		{
			System.out.println("Usage: java AdaptiveTester <filename>");
			System.exit(0);
		}
		...
		AdaptiveTester encoder = new AdaptiveTester(prefix + filename);
	}

	public AdaptiveTester(String _filename)
	{
		filename = _filename;
		try
		{
			...
			if(raster_type == BufferedImage.TYPE_3BYTE_BGR)
			{
			    ...
			    JFrame frame = new JFrame("AdaptiveTester");
	...
	class ApplyHandler implements ActionListener
	{
		...
		public ApplyHandler()
		{
		    ...
		    // Segmented data for each channel.
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			for(int i = 0; i < 3; i++)
			{
				...
				int bit_length = channel_length[id];
