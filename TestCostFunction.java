...
public class TestCostFunction
{
	...
	public static void main(String[] args)
	{
		if (args.length != 1)
		{
			System.out.println("Usage: java TestCostFunction <filename>");
			System.exit(0);
		}
		...
		TestCostFunction encoder = new TestCostFunction(prefix + filename);
	}

	public TestCostFunction(String _filename)
	{
		filename = _filename;
		try
		{
			...
			if(raster_type == BufferedImage.TYPE_3BYTE_BGR)
			{
			    ...
			    JFrame frame = new JFrame("TestCostFunction");
		...
		public void actionPerformed(ActionEvent event)
		{
		    ...
		    for(int i = 0; i < 6; i++)
		    {
				...
				*/
			    ...
			    int compression_length3 = 0;
			    if(zero_one_ratio > .5)
			    {
			    	compression_length3 = DeltaMapper.compressZeroStrings(delta_string, length3, compressed_string);	
			    }
			    else
			    {
