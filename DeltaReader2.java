...
public class DeltaReader2
{
	...
	public static void main(String[] args)
	{
		if (args.length != 1)
		{
			System.out.println("Usage: java DeltaReader2 <filename>");
			System.exit(0);
		}
	
		DeltaReader2 reader = new DeltaReader2(args[0]);
	}
	
	public DeltaReader2(String filename)
	{
		try
		{
