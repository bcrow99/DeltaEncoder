...
public class PackTester
{
	...
	public static void main(String[] args)
	{
		if (args.length != 1)
		{
			System.out.println("Usage: java PackTester <filename>");
			System.exit(0);
		}
		String      prefix    = new String("C:/Users/Brian Crowley/Desktop/");
		String      filename  = new String(args[0]);
		PackTester processor = new PackTester(prefix + filename);
	}

	public PackTester(String _filename)
	{
		filename = _filename;
		try
		{
			...
			if(raster_type == BufferedImage.TYPE_3BYTE_BGR)
			{
			    ...
			    JFrame frame = new JFrame("Pack Tester");
	...
	class ApplyHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
		    ...
		    double packed_pixel_bits_pixel_bits_ratio = pixel_length;
		    packed_pixel_bits_pixel_bits_ratio       /= xdim * ydim * 8;
		    
		    double packed_delta_bits_pixel_bits_ratio = delta_length;
		    packed_delta_bits_pixel_bits_ratio       /= xdim * ydim * 8;
		    
		    System.out.println("The ratio of packed pixel bits to pixel bits is " + String.format("%.2f", packed_pixel_bits_pixel_bits_ratio));
		    System.out.println("The ratio of packed delta bits to pixel bits is " + String.format("%.2f", packed_delta_bits_pixel_bits_ratio));
