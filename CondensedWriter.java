...
public class CondensedWriter
{
	...
	public static void main(String[] args)
	{
		if (args.length != 1)
		{
			System.out.println("Usage: java CondensedWriter <filename>");
			System.exit(0);
		}
		String prefix       = new String("C:/Users/Brian Crowley/Desktop/");
		String filename     = new String(args[0]);
	
		CondensedWriter writer = new CondensedWriter(prefix + filename);
	}

	public CondensedWriter(String _filename)
	{
		filename = _filename;
		try
		{
		        ...
		        for(int i = 0; i < 3; i++)
		        {
		            ...
		            else
			        {
			            ...
			            for(int k = 0; k < n; k++)
			            {
			            	...
			            	byte iterations = (byte)(segment[segment.length - 1] & 31);
